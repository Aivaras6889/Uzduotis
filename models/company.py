...
class Company(Base):
    ...
    def __repr__(self):
        return f"Company(id = {self.id}.Company Name = {self.company_name}, industry = {self.industry}, Found_Date = {self.founded_date}, Description = {self.description}, Address = {self.address};)"
